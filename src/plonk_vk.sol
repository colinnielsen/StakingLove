...
contract UltraVerifier is BaseUltraVerifier {
    ...
    function verify_noinputs(bytes calldata _proof) external view returns (bool) {
        bytes32[] memory empty_pub_input = new bytes32[](0);
        return this.verify(_proof, empty_pub_input);
    }
}
